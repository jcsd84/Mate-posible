...
plot((tabla), col = "red", main = "Per̼ en eliminatorias", type = "l", lty = "dashed")
...
plot((puntos~partidos), col = "red", main = "Per̼ en eliminatorias", type = "l", lty = "dashed")
lines(lowess(tabla), col = "blue")
...
scatterplot(puntos~partidos | eliminatoria, reg.line = F, span=1, smoother=loessLine,
            data = tablafdf, xlab= "partidos", ylab = "Puntos", main= "Per̼",
...
scatterplot(puntos~partidos | eliminatoria, reg.line = F, span =2, smoother=loessLine,
            data = tablaf1, xlab= "partidos", ylab = "Puntos", main= "Per̼ en eliminatorias", 
